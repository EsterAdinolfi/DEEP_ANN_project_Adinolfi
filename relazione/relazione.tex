...
\paragraph{Osservazioni:}
\begin{itemize}
    \item L'alignment medio è \textbf{0.629 (62.9\%)}, con ampia variabilità tra domande (alcune raggiungono valori >0.9, altre scendono sotto 0.3).
    \item Il modello si allinea meglio su topic con chiare preferenze maggioritarie (es. questioni di sicurezza, tecnologia).
