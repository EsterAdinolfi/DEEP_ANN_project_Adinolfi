...
\begin{tabular}{lccc}
\toprule
\textbf{Modello} & \textbf{Parametri totali}  & \textbf{Layer interni} \\
\midrule
...
\bottomrule
\end{tabular}
\caption{Modelli della famiglia Pythia analizzati nel progetto.}
\end{table}

\subsection{L'importanza di utilizzare pre-trained models}
...
L'impiego di questa specifica tipologia di modelli è funzionale a quanto dimostrato nell'articolo di Santurkar et al. (2023) \cite{santurkar2023whose}: poiché l'allineamento tende ad amplificare artificialmente i bias del modello verso posizioni demografiche specifiche (spesso riconducibili a fasce istruite e di orientamento \emph{liberale}), testare modelli "base" permette di misurare le opinioni nella loro forma "nativa". 

L'obiettivo è dunque verificare quanto la semplice scala del modello influenzi la sua capacità di gestire quesiti a scelta multipla e quanto i bias siano intrinsechi alla struttura stessa della rete.
