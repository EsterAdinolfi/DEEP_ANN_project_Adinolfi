...
L'impiego di questa specifica tipologia di modelli è funzionale a quanto dimostrato nell'articolo di Santurkar et al. (2023): poiché l'allineamento tende ad amplificare artificialmente i bias del modello verso posizioni demografiche specifiche (spesso riconducibili a fasce istruite e di orientamento \emph{liberal}), testare modelli base permette di misurare le opinioni nella loro forma "nativa". 

\subsection{Estensibilità della pipeline}
Il framework software sviluppato per questo progetto è stato comunque progettato per essere altamente flessibile. Se in futuro si desiderasse estendere l'analisi ad altre famiglie, l'architettura supporta l'integrazione immediata semplicemente specificando il nome del nuovo modello nel sistema di configurazione.

\end{document}autori del paper di Pythia (Biderman et al.)