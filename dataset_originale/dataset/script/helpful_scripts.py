...
def get_data_path():
    """
    Calcola il percorso della cartella 'human_resp' risalendo di un livello.
    Script: .../dataset_originale/dataset/script/helpful_scripts.py
    Target: .../dataset_originale/human_resp/
    """
    # os.path.abspath(__file__) garantisce che il percorso sia corretto ovunque lanci lo script
    current_script_dir = os.path.dirname(os.path.abspath(__file__))
    # Sale di due livelli: da 'script' → 'dataset' → 'dataset_originale'
